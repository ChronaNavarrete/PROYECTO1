...
class Post(models.Model):
    ...
    concepto = models.CharField('Concepto a tratar', max_length=200, choices=TODOS_LOS_CONCEPTOS, null=True)

    content = RichTextField(blank=True, null=True)
    thumbnail = models.ImageField('Imagen para el fondo')
...
post_save.connect(CrearPostCabildo, sender=Articulo)'''
